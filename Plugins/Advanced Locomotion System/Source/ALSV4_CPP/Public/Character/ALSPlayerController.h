...
protected:
	...
	UFUNCTION()
	void NextWeaponAction(const FInputActionValue& Value);

	UFUNCTION()
	void PrevWeaponAction(const FInputActionValue& Value);
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "ALS")
	TObjectPtr<AALSCharacter> PossessedCharacterBase = nullptr;
